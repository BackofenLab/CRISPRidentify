...
class AdvancedFuzzySearch:
    ...
    def _match(self):
        ...
        self.matching_l_flank = list(regex.finditer(self.pattern_flank, self.left_flank))
        self.matching_r_flank = list(regex.finditer(self.pattern_flank, self.right_flank))
